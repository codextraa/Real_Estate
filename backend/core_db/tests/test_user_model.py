...
# class AgentModelImageTests(TestCase):
...
#         self.agent.image_url = self.image
#         self.agent.save()
#         self.image_path = os.path.join(settings.MEDIA_ROOT, self.agent.image_url.name)

#         self.assertTrue(self.agent.image_url)
#         self.assertEqual(self.agent.image_url.name, "profile_images/test_image.jpg")
