...
class AIReportViewSetTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.detail_url = lambda pk: reverse("report-detail", kwargs={"pk": pk})
    ...
    @patch("report_api.views.parallel_report_generator.delay")
    ...
    def test_delete_report_forbidden_for_other_user(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        self.assertEqual(
            response.data["detail"], "No AIReport matches the given query."
        )
