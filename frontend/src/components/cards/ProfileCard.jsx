        ...
        <div className={styles.agentProfileContainer}>
          ...
          <div className={styles.profileContainer}>
            <div className={styles.bioInfo}>
              <h1 className={styles.subTitle}>{userData.user.first_name + " " + userData.user.last_name}</h1>
            ...
            <div className={styles.profileInfos}>
              ...
              <div className={styles.storedContent}>{userData.user.first_name}</div>
              <label className={styles.profileLabel}>Last Name</label>
              <div className={styles.storedContent}>{userData.user.last_name}</div>
              <label className={styles.profileLabel}>Username</label>
              <div className={styles.storedContent}>{userData.user.username}</div>
            </div>
            <div className={styles.companyInfo}>
              <h1 className={styles.subTitle2}>Company Information</h1>
              <label className={styles.profileLabel}>Company Name</label>
              <div className={styles.storedContent}>{userData.company_name}</div>
            </div>
            <div className={styles.agentProfileDetailButtonContainer}>
              <Link href={`/profile/${userData.slug}/edit`} className={styles.editProfileButton}>
