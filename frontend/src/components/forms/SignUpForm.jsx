      ...
      <div className={styles.formInputContainer}>
        ...
        {userType === "agent" && (
          <div className={styles.inputContainer}> 
            <input 
              ...
              className={styles.input}
            />
            {Object.keys(state.errors).length > 0 && state.errors.company_name && (
              <span className={styles.errorText}>{state.errors.company_name}</span> 
            )}
          </div>
        )}
        ...
        <div className={styles.inputContainer}> 
          ...
          <span className={styles.inputHint}>
            Username  must be at least 6 characters long, and cannot contain spaces. Username can only contain letters, numbers, periods, underscores, hyphens, and @ signs.
          </span>
